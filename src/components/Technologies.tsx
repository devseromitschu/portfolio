...
export default function Technologies() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/users/devseromitschu/repos").then((res) =>
      res.json().then((json) => {
        let newData = data;
  ...
  return (
    <div className="grid h-full grid-cols-4 gap-7 rounded-3xl border border-white/10 bg-orange-800 p-6">
      {data.map((item, i) => (
